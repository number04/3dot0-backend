...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('theleague:date')->dailyAt('8:00');
        $schedule->command('theleague:matchup')->dailyAt('8:00');
        $schedule->command('theleague:claim')->dailyAt('8:00');
        $schedule->command('theleague:waiver')->dailyAt('8:00');
    }
