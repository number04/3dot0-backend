...
class StatsQueries
{
    ...
    {
        // teams
        $json = file_get_contents('https://api.nhle.com/stats/rest/team?isAggregate=false&reportType=basic&isGame=true&reportName=teamsummary&cayenneExp=leagueId=133%20and%20gameDate%3E=%222019-10-09%22%20and%20gameDate%3C=%222019-10-09%2023:59:59%22%20and%20gameTypeId=2');
        ...
        // skaters
        $json = file_get_contents('https://api.nhle.com/stats/rest/skaters?isAggregate=false&reportType=basic&isGame=true&reportName=skatersummary&cayenneExp=leagueId=133%20and%20gameDate%3E=%222019-10-09%22%20and%20gameDate%3C=%222019-10-09%2023:59:59%22%20and%20gameTypeId=2');
        ...
        $json = file_get_contents('https://api.nhle.com/stats/rest/skaters?isAggregate=false&reportType=basic&isGame=true&reportName=realtime&cayenneExp=leagueId=133%20and%20gameDate%3E=%222019-10-09%22%20and%20gameDate%3C=%222019-10-09%2023:59:59%22%20and%20gameTypeId=2');
        ...
        // goalies
        $json = file_get_contents('https://api.nhle.com/stats/rest/goalies?isAggregate=false&reportType=basic&isGame=true&reportName=goaliesummary&cayenneExp=leagueId=133%20and%20gameDate%3E=%222019-10-09%22%20and%20gameDate%3C=%222019-10-09%2023:59:59%22%20and%20gameTypeId=2');
